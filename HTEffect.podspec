#
#  Be sure to run `pod spec lint HTEffect.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                             虹图人像人体特效HTEffectSDK, (不包含UI)
                   DESC

  spec.homepage     = "https://github.com/Texeljoy/HTEffectPod"
  ...
  spec.source       = { :git => "https://github.com/Texeljoy/HTEffectPod.git", :tag => spec.version.to_s }
